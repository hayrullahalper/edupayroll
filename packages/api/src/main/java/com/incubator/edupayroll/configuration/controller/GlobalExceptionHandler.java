...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Response<?, GlobalErrorCode>> handleMethodArgumentNotValidException(
    ...
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(Response.error(GlobalErrorCode.INVALID_REQUEST_BODY, errors).build());
  }

  @ExceptionHandler({ConstraintViolationException.class})
  public ResponseEntity<Response<?, GlobalErrorCode>> handleConstraintViolationException(
    ...
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(Response.error(GlobalErrorCode.INVALID_CONSTRAINTS, violations).build());
  }
