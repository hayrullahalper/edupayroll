...
import com.incubator.edupayroll.dto.record.RecordCreateDTO;
import com.incubator.edupayroll.dto.record.RecordUpdateTeacherDTO;
import com.incubator.edupayroll.dto.record.RecordUpdateTypeDTO;
...
public class RecordController {
  ...
  public ResponseEntity<Response<List<Record>, RecordErrorCode>> getAll(
    ...
    List<Record> records = recordService.getRecordsByDocumentId(documentId).reversed();
