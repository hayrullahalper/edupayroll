...
public class SchoolController {
  ...
  public ResponseEntity<Response<School, SchoolErrorCode>> updateSchool(
    ...
    return ResponseEntity.ok().body(Response.data(SchoolMapper.toDTO(updatedSchool)).build());
  }
  ...
  public ResponseEntity<Response<School, SchoolErrorCode>> getSchool() {
    ...
    return ResponseEntity.ok().body(Response.data(SchoolMapper.toDTO(school)).build());
  }
}
