...
public class TeacherController {
    ...
    public ResponseEntity<Response<Teacher, TeacherErrorCode>> updateTeacher(
        ...
        var updatedTeacher =
                teacherService.update(teacher, input.getFirstName(), input.getLastName(), input.getBranch(), input.getIdentityNo());
    ...
    public ResponseEntity<Response<Teacher, TeacherErrorCode>> createTeacher(
        ...
        var user = userService.getAuthenticatedUser();
        var createdTeacher =
                teacherService.create(input.getFirstName(), input.getLastName(), input.getBranch(), input.getIdNumber(), user);
