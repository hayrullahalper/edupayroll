...
public class EmailService {
    ...
    public void sendRegisterConfirmationEmail(String to, String token) {
        try {
            ...
            sendEmail(to, "auth/register-confirmation", Map.of("verification_url", ub.build().toString()));
    ...
    private String getTemplate(String template, Map<String, Object> context) {
        try {
            ...
            var name = env.getProperty("spring.mustache.prefix") + template + env.getProperty("spring.mustache.suffix");
    ...
    private String getSource() {
        return env.getProperty("mailer.from.name") + " <" + env.getProperty("mailer.from.address") + ">";
    }
